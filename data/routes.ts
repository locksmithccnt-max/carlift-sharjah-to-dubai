...
export const ROUTES: RouteData[] = [
  {
    ...
    shortDescription:
      "Reliable daily car lift from Sharjah to Business Bay from AED 26/day or AED 570/month. AC-comfortable, punctual pick-ups from Al Nahda, Muwaileh, Al Taawun, and surrounding Sharjah areas.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "Daily car lift from Sharjah to Business Bay costs from AED 26 per trip. Monthly packages start from AED 570, covering 22 working days of one-way or 44 trips for two-way.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Car lift from Sharjah to Dubai costs from AED 22 per day. Monthly subscriptions start at AED 500 for one-way daily trips (22 working days).",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Evening and morning car lift from Dubai to Sharjah from AED 22/day. Fixed monthly pricing, no surge, verified drivers.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 22 per trip, or AED 500/month for daily one-way. Two-way monthly packages (Dubai–Sharjah–Dubai) start from AED 900.",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Sharjah to JLT from AED 28/day or AED 600/month. Covers all JLT clusters and DMCC area.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 28 per day or AED 600 per month for one-way daily trips. Two-way monthly packages are available.",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Sharjah to Dubai Investment Park (DIP) from AED 29/day or AED 620/month. Direct, punctual service covering DIP 1 and DIP 2.",
    longDescription:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "AED 29 per trip or AED 620 per month (one-way, 22 working days).",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Daily car lift from Sharjah to Al Quoz from AED 25/day or AED 550/month. Serves Al Quoz Industrial and residential zones.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 25 per trip, or AED 550 per month for daily one-way service.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Sharjah to Al Barsha from AED 26/day or AED 580/month. Covers Al Barsha 1, 2, 3, and Al Barsha South.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "AED 26 per day or AED 580 per month (22 working days, one-way).",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Long-route car lift from Sharjah to Jebel Ali / JAFZA from AED 30/day or AED 650/month. Early departures to beat E11 traffic.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 30/trip or AED 650/month. Jebel Ali Free Zone specific drop-offs available.",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Sharjah to Dubai Internet City from AED 28/day or AED 600/month. Serving tech-sector commuters at DIC and neighboring Media City.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "Yes, we operate daily departures from major Sharjah areas to Dubai Internet City. Monthly plans start at AED 600.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Sharjah to Dubai Media City from AED 28/day or AED 600/month.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "AED 28 per day or AED 600 per month (one-way, 22 working days).",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Short-route car lift from Sharjah to Dubai Silicon Oasis (DSO) from AED 23/day or AED 520/month. One of the closest Dubai tech zones to Sharjah.",
    longDescription:
      "Dubai Silicon Oasis is only 22 km from central Sharjah, making this one of the quickest commutes on our network. Ideal for tech workers, university staff, and healthcare workers at nearby Rashid Hospital.",
    faqs: [
      {
        q: "How much is a car lift from Sharjah to Silicon Oasis?",
        a: "From AED 23 per trip or AED 520 per month — one of our most affordable routes given the short distance.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Intra-Dubai car lift from Silicon Oasis to Business Bay from AED 22/day or AED 500/month. Avoids Metro interchange hassle.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "Yes. We operate daily car lifts from Dubai Silicon Oasis to Business Bay, starting from AED 22/trip.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from International City to Business Bay from AED 22/day or AED 500/month. Popular with International City residents working in the Business Bay district.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 22 per day or AED 500 per month (22 working days, one-way).",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Daily car lift from Ajman to Dubai from AED 27/day or AED 600/month. Comfortable, fixed-price alternative to RTA or solo rideshare.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 27 per day or AED 600 per month for daily one-way service.",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Short-route car lift from Ajman to Sharjah from AED 18/day or AED 450/month. One of our most affordable intercity routes.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 18 per trip or AED 450 per month — one of our most affordable routes.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Dubai to Ajman from AED 27/day or AED 600/month. Evening return service from major Dubai areas.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "AED 27 per day or AED 600 per month for daily one-way service back to Ajman.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Intercity car lift from Dubai to Al Ain from AED 34/day or AED 750/month. Long-distance shared ride with scheduled departures.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 34 per trip or AED 750 per month for daily one-way service.",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Sharjah to Ras Al Khaimah from AED 31/day or AED 680/month. Direct intercity service.",
    longDescription:
    ...
    faqs: [
      {
        ...
        a: "From AED 31 per day or AED 680 per month.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Car lift from Dubai to Sharjah SAIF Zone from AED 23/day or AED 520/month. Popular with freezone workers commuting from Dubai.",
    longDescription:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "From AED 23 per day or AED 520 per month.",
      },
    ],
