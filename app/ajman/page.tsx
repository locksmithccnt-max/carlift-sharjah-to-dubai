...
const FAQS = [
  {
    ...
    a: "Yes. We operate car lifts from Ajman to Dubai (from AED 550/day) and Ajman to Sharjah (from AED 500/day). Ladies-only option available on all Ajman routes.",
  },
  {
    q: "How much is a car lift from Ajman to Dubai?",
    a: "Car lift from Ajman to Dubai starts from AED 550 per day or AED 5,000 per month (22 working days, one-way).",
  },
]
